    ...
    <div className={styles.global}>
      ...
      <div className={`${styles.bgWrap} ${styles.bg}`}>
        ...
        <div className={styles.content}>
          <h2 className="text-white lg:text-4xl text-center text-4xl font-semibold md:text-7xl">
            About Us
          </h2>
          <p className="text-white lg:text-xl text-center text-xl leading-loose py-3">
